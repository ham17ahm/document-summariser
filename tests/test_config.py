...
def test_master_config_loads():
    ...
    assert config.providers["chatgpt"].extra == {
    ...
    assert config.providers["gemini_consolidate"].model == "gemini-3.1-pro-preview"
    ...
    assert config.providers["grok"].extra == {"prompt_cache": {"enabled": True}}
